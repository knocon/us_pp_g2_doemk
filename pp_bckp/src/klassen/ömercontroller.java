...
public class Controller extends Application {
	...
	@FXML
	private Button filterAuftrag;
	@FXML
	void filterAuftrag(ActionEvent event) {
		String filterParam = comboAuftrag.getValue();
		String filterWert = filterFieldAuftrag.getText();
		ObservableList<Auftrag> pList = null;
		if(!filterWert.isEmpty()) {
			switch(filterParam) {
				case "Titel" : pList = verwaltung.filterByParameter("titel", filterWert, "Auftrag"); break;
				case "Art" : pList = verwaltung.filterByParameter("art", filterWert, "Auftrag"); break;
				case "Status" : pList = verwaltung.filterByParameter("datum", filterWert, "Auftrag"); break;
					}
		}
		
		tableView.setItems(pList);
		System.out.println(filterFieldAuftrag.getText());
